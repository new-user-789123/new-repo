...
export default function StaffCreatePassword(){
  ...
  return (
    <Flex height="100vh" alignItems="center" justifyContent="center" background={backgroundColor} direction="column">
      <Flex direction="column" background={formBackgroundColor} p={12} rounded={6}  boxShadow='dark-lg'>
        ...
        <Input placeholder="Create Password" variant="filled"  mb={3} type="text" marginBottom="10px"/>
        ...
        <Flex justifyContent="center" alignItems="center"  direction="row" marginBottom="20px" marginTop="10px">
          <Button mb={1} onClick={toggleColorMode}>Toggle Theme</Button>
        </Flex>     
      </Flex>
      {SmallCentered()}
    </Flex>
